...
Traditional SDLCs evolved to manage one dominant constraint: **human execution**.

Historically:
- writing code was slow and expensive,
- refactoring carried high risk,
- coordination between people was costly,
- late errors were hard to correct.

Processes such as Waterfall and Agile optimised around these realities.  
...
Building faster does not help if direction is wrong.
...
In AI-SDLC v1.0, progress is measured by **decisions informed by evidence**, not by tasks completed.
